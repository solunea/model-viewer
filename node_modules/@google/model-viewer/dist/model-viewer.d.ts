...
declare class ModelScene extends Scene$1 {
    ...
    private skyboxDofMesh;
    private skyboxDofSkybox;
    private skyboxDofDepth;
    private skyboxDofSampleCache;
    private skyboxDofFocusMode;
    private skyboxDofManualFocus;
    private skyboxDofCurrentFocus;
    private skyboxDofStrength;
    private skyboxDofMaxBlur;
    private skyboxDofFocusSmoothing;
    private skyboxDofDepthInvert;
    ...
    private alignModelFloor;
    private getOccupiedBounds;
    private applyAutoSideOffset;
    updateModelTransforms(index: number, offset?: string | null, _orientation?: string | null, scale?: string | null, autoOffset?: boolean): void;
    /**
    ...
    setSkyboxDofOptions(options: SkyboxDofOptions): void;
    private updateSkyboxDofUniforms;
    private updateSkyboxDofTransform;
    private getSkyboxDofDepthCanvas;
    private getSkyboxDofCenterUv;
    private rgbToHue;
    private decodeSkyboxDofDepthPixel;
...
declare class TextureUtils {
    ...
    private skyboxCache;
    private skyboxCacheUrls;
    private blurMaterial;
    private blurScene;
    private blurTempTarget;
    ...
    private loadTransientEquirect;
    /**
     * Returns a { skybox, environmentMap } object with the targets/textures
     * accordingly. `skybox` is a WebGLRenderCubeTarget, and `environmentMap`
     * is a Texture from a WebGLRenderCubeTarget.
     */
    generateEnvironmentMapAndSkybox(skyboxUrl?: string | null, environmentMapUrl?: string | null, progressCallback?: (progress: number) => void, withCredentials?: boolean, skyboxCacheKey?: string | null): Promise<EnvironmentMapAndSkybox>;
    /**
...
declare class Renderer extends EventDispatcher<{
    ...
    private sceneSize;
    private disposeViewHelper;
    private renderViewHelper;
    hasViewHelperAtPoint(scene: ModelScene, event: PointerEvent): boolean;
    handleViewHelperClick(scene: ModelScene, event: PointerEvent): ViewHelperOrbit | null;
    private copyPixels;
    /**
...
declare interface EnvironmentInterface {
    ...
    preloadSkybox(skyboxImage?: string | null, environmentImage?: string | null): Promise<void>;
}
